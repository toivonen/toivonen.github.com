(function(g) {
  var __bem_xjst = (function(exports) {
     var __$ref={};function apply(ctx){try{return applyc(ctx||this,__$ref)}catch(e){(ctx||this).xjstContext=e;throw e}}exports.apply=apply;function applyc(__$ctx,__$ref){var cache;var cache;var cache;var __$r=__$g0(__$ctx,__$ref);if(__$r!==__$ref)return __$r}[function(exports,context){var BEM_={},toString=Object.prototype.toString,isArray=Array.isArray||function(obj){return toString.call(obj)==="[object Array]"},SHORT_TAGS={area:1,base:1,br:1,col:1,command:1,embed:1,hr:1,img:1,input:1,keygen:1,link:1,meta:1,param:1,source:1,wbr:1};!function(BEM,undefined){var MOD_DELIM="_",ELEM_DELIM="__",NAME_PATTERN="[a-zA-Z0-9-]+";function buildModPostfix(modName,modVal){var res=MOD_DELIM+modName;if(modVal!==true)res+=MOD_DELIM+modVal;return res}function buildBlockClass(name,modName,modVal){var res=name;if(modVal)res+=buildModPostfix(modName,modVal);return res}function buildElemClass(block,name,modName,modVal){var res=buildBlockClass(block)+ELEM_DELIM+name;if(modVal)res+=buildModPostfix(modName,modVal);return res}BEM.INTERNAL={NAME_PATTERN:NAME_PATTERN,MOD_DELIM:MOD_DELIM,ELEM_DELIM:ELEM_DELIM,buildModPostfix:buildModPostfix,buildClass:function(block,elem,modName,modVal){var typeOfModName=typeof modName;if(typeOfModName==="string"||typeOfModName==="boolean"){var typeOfModVal=typeof modVal;if(typeOfModVal!=="string"&&typeOfModVal!=="boolean"){modVal=modName;modName=elem;elem=undefined}}else if(typeOfModName!=="undefined"){modName=undefined}else if(elem&&typeof elem!=="string"){elem=undefined}if(!(elem||modName)){return block}if(elem)return buildElemClass(block,elem,modName,modVal);else return buildBlockClass(block,modName,modVal)},buildModsClasses:function(block,elem,mods){var res="";if(mods){var modName;for(modName in mods){if(!mods.hasOwnProperty(modName))continue;var modVal=mods[modName];if(!modVal&&modVal!==0)continue;typeof modVal!=="boolean"&&(modVal+="");res+=" "+(elem?buildElemClass(block,elem,modName,modVal):buildBlockClass(block,modName,modVal))}}return res},buildClasses:function(block,elem,mods){var res="";if(elem)res+=buildElemClass(block,elem);else res+=buildBlockClass(block);res+=this.buildModsClasses(block,elem,mods);return res}}}(BEM_);var ts={'"':"&quot;","&":"&amp;","<":"&lt;",">":"&gt;"},f=function(t){return ts[t]||t};var buildEscape=function(r){r=new RegExp(r,"g");return function(s){return(""+s).replace(r,f)}};function BEMContext(context,apply_){this.ctx=typeof context===null?"":context;this.apply=apply_;this._str="";var self=this;this._buf={push:function(){var chunks=Array.prototype.slice.call(arguments).join("");self._str+=chunks},join:function(){return this._str}};this._=this;this._start=true;this._mode="";this._listLength=0;this._notNewList=false;this.position=0;this.block=undefined;this.elem=undefined;this.mods=undefined;this.elemMods=undefined}context.BEMContext=BEMContext;BEMContext.prototype.isArray=isArray;BEMContext.prototype.isSimple=function isSimple(obj){if(!obj||obj===true)return true;var t=typeof obj;return t==="string"||t==="number"};BEMContext.prototype.isShortTag=function isShortTag(t){return SHORT_TAGS.hasOwnProperty(t)};BEMContext.prototype.extend=function extend(o1,o2){if(!o1||!o2)return o1||o2;var res={},n;for(n in o1)o1.hasOwnProperty(n)&&(res[n]=o1[n]);for(n in o2)o2.hasOwnProperty(n)&&(res[n]=o2[n]);return res};var cnt=0,id=+new Date,expando="__"+id,get=function(){return"uniq"+id+ ++cnt};BEMContext.prototype.identify=function(obj,onlyGet){if(!obj)return get();if(onlyGet||obj[expando]){return obj[expando]}else{return obj[expando]=get()}};BEMContext.prototype.xmlEscape=buildEscape("[&<>]");BEMContext.prototype.attrEscape=buildEscape('["&<>]');BEMContext.prototype.BEM=BEM_;BEMContext.prototype.isFirst=function isFirst(){return this.position===1};BEMContext.prototype.isLast=function isLast(){return this.position===this._listLength};BEMContext.prototype.generateId=function generateId(){return this.identify(this.ctx)};var oldApply=exports.apply;exports.apply=BEMContext.apply=function _apply(context){var ctx=new BEMContext(context||this,oldApply);ctx.apply();return ctx._str};BEMContext.prototype.reapply=BEMContext.apply}].forEach(function(fn){fn(exports,this)},{recordExtensions:function(ctx){ctx._buf=undefined;ctx._mode=undefined;ctx.ctx=undefined;ctx._str=undefined;ctx.block=undefined;ctx.elem=undefined;ctx._notNewList=undefined;ctx.position=undefined;ctx._listLength=undefined;ctx.__$a=0;ctx._currBlock=undefined;ctx.mods=undefined;ctx.elemMods=undefined}});function __$b4(__$ctx,__$ref){__$ctx.__$a=0;{var _$1lctx__$0=__$ctx.ctx,_$1lprops__$1=["title","target"],_$1lp__$2=typeof _$1lctx__$0.url,_$1la__$3={href:_$1lp__$2==="undefined"||_$1lp__$2==="string"?_$1lctx__$0.url:(_$1lp__$2=[],function(){var __$r__$4;var __$l0__$5=__$ctx._buf;__$ctx._buf=_$1lp__$2;var __$l1__$6=__$ctx._mode;__$ctx._mode="";var __$l2__$7=__$ctx.ctx;__$ctx.ctx=_$1lctx__$0.url;__$r__$4=applyc(__$ctx,__$ref);__$ctx._buf=__$l0__$5;__$ctx._mode=__$l1__$6;__$ctx.ctx=__$l2__$7;return __$r__$4}(),_$1lp__$2.join(""))};while(_$1lp__$2=_$1lprops__$1.pop()){_$1lctx__$0[_$1lp__$2]&&(_$1la__$3[_$1lp__$2]=_$1lctx__$0[_$1lp__$2])}return _$1la__$3}return}function __$b5(__$ctx,__$ref){__$ctx.__$a=0;var attrs__$8={},ctx__$9=__$ctx.ctx,url__$10=ctx__$9.url,typeOfUrl__$11=typeof url__$10;typeOfUrl__$11!=="undefined"&&(attrs__$8.href=typeOfUrl__$11==="string"?url__$10:BEMHTML.apply(url__$10));ctx__$9.title&&(attrs__$8.title=ctx__$9.title);ctx__$9.target&&(attrs__$8.target=ctx__$9.target);return attrs__$8}function __$b15(__$ctx,__$ref){__$ctx.__$a=0;var _this__$12=__$ctx,BEM___$13=_this__$12.BEM,v__$14=__$ctx.ctx,isBEM__$15,tag__$16,result__$17;var __$r__$18;var __$l0__$19=__$ctx._str;__$ctx._str="";var __$r__$20;var __$l1__$21=__$ctx._mode;__$ctx._mode="tag";__$r__$20=applyc(__$ctx,__$ref);__$ctx._mode=__$l1__$21;tag__$16=__$r__$20;typeof tag__$16!=="undefined"||(tag__$16=v__$14.tag);typeof tag__$16!=="undefined"||(tag__$16="div");if(tag__$16){var jsParams__$22,js__$23;if(__$ctx.block&&v__$14.js!==false){var __$r__$24;var __$l2__$25=__$ctx._mode;__$ctx._mode="js";__$r__$24=applyc(__$ctx,__$ref);__$ctx._mode=__$l2__$25;js__$23=__$r__$24;js__$23=js__$23?__$ctx._.extend(v__$14.js,js__$23===true?{}:js__$23):v__$14.js===true?{}:v__$14.js;js__$23&&((jsParams__$22={})[BEM___$13.INTERNAL.buildClass(__$ctx.block,v__$14.elem)]=js__$23)}__$ctx._str+="<"+tag__$16;var __$r__$26;var __$l3__$27=__$ctx._mode;__$ctx._mode="bem";__$r__$26=applyc(__$ctx,__$ref);__$ctx._mode=__$l3__$27;isBEM__$15=__$r__$26;typeof isBEM__$15!=="undefined"||(isBEM__$15=typeof v__$14.bem!=="undefined"?v__$14.bem:v__$14.block||v__$14.elem);var __$r__$29;var __$l4__$30=__$ctx._mode;__$ctx._mode="cls";__$r__$29=applyc(__$ctx,__$ref);__$ctx._mode=__$l4__$30;var cls__$28=__$r__$29;cls__$28||(cls__$28=v__$14.cls);var addJSInitClass__$31=v__$14.block&&jsParams__$22;if(isBEM__$15||cls__$28){__$ctx._str+=' class="';if(isBEM__$15){__$ctx._str+=BEM___$13.INTERNAL.buildClasses(__$ctx.block,v__$14.elem,v__$14.elemMods||v__$14.mods);var __$r__$33;var __$l5__$34=__$ctx._mode;__$ctx._mode="mix";__$r__$33=applyc(__$ctx,__$ref);__$ctx._mode=__$l5__$34;var mix__$32=__$r__$33;v__$14.mix&&(mix__$32=mix__$32?mix__$32.concat(v__$14.mix):v__$14.mix);if(mix__$32){var visited__$35={},visitedKey__$36=function(block,elem){return(block||"")+"__"+(elem||"")};visited__$35[visitedKey__$36(__$ctx.block,__$ctx.elem)]=true;if(!__$ctx._.isArray(mix__$32))mix__$32=[mix__$32];for(var i__$37=0;i__$37<mix__$32.length;i__$37++){var mixItem__$38=mix__$32[i__$37],hasItem__$39=mixItem__$38.block||mixItem__$38.elem,block__$40=mixItem__$38.block||mixItem__$38._block||_this__$12.block,elem__$41=mixItem__$38.elem||mixItem__$38._elem||_this__$12.elem;if(hasItem__$39)__$ctx._str+=" ";__$ctx._str+=BEM___$13.INTERNAL[hasItem__$39?"buildClasses":"buildModsClasses"](block__$40,mixItem__$38.elem||mixItem__$38._elem||(mixItem__$38.block?undefined:_this__$12.elem),mixItem__$38.elemMods||mixItem__$38.mods);if(mixItem__$38.js){(jsParams__$22||(jsParams__$22={}))[BEM___$13.INTERNAL.buildClass(block__$40,mixItem__$38.elem)]=mixItem__$38.js===true?{}:mixItem__$38.js;addJSInitClass__$31||(addJSInitClass__$31=block__$40&&!mixItem__$38.elem)}if(hasItem__$39&&!visited__$35[visitedKey__$36(block__$40,elem__$41)]){visited__$35[visitedKey__$36(block__$40,elem__$41)]=true;var __$r__$43;var __$l6__$44=__$ctx._mode;__$ctx._mode="mix";var __$l7__$45=__$ctx.block;__$ctx.block=block__$40;var __$l8__$46=__$ctx.elem;__$ctx.elem=elem__$41;__$r__$43=applyc(__$ctx,__$ref);__$ctx._mode=__$l6__$44;__$ctx.block=__$l7__$45;__$ctx.elem=__$l8__$46;var nestedMix__$42=__$r__$43;if(nestedMix__$42){for(var j__$47=0;j__$47<nestedMix__$42.length;j__$47++){var nestedItem__$48=nestedMix__$42[j__$47];if(!nestedItem__$48.block&&!nestedItem__$48.elem||!visited__$35[visitedKey__$36(nestedItem__$48.block,nestedItem__$48.elem)]){nestedItem__$48._block=block__$40;nestedItem__$48._elem=elem__$41;mix__$32.splice(i__$37+1,0,nestedItem__$48)}}}}}}}if(cls__$28)__$ctx._str+=isBEM__$15?" "+cls__$28:cls__$28;if(addJSInitClass__$31)__$ctx._str+=' i-bem"';else __$ctx._str+='"'}if(isBEM__$15&&jsParams__$22){__$ctx._str+=' data-bem="'+__$ctx._.attrEscape(JSON.stringify(jsParams__$22))+'"'}var __$r__$50;var __$l9__$51=__$ctx._mode;__$ctx._mode="attrs";__$r__$50=applyc(__$ctx,__$ref);__$ctx._mode=__$l9__$51;var attrs__$49=__$r__$50;attrs__$49=__$ctx._.extend(attrs__$49,v__$14.attrs);if(attrs__$49){var name__$52,attr__$53;for(name__$52 in attrs__$49){attr__$53=attrs__$49[name__$52];if(attr__$53===undefined)continue;__$ctx._str+=" "+name__$52+'="'+__$ctx._.attrEscape(__$ctx._.isSimple(attr__$53)?attr__$53:__$ctx.reapply(attr__$53))+'"'}}}if(__$ctx._.isShortTag(tag__$16)){__$ctx._str+="/>"}else{if(tag__$16)__$ctx._str+=">";var __$r__$55;var __$l10__$56=__$ctx._mode;__$ctx._mode="content";__$r__$55=applyc(__$ctx,__$ref);__$ctx._mode=__$l10__$56;var content__$54=__$r__$55;if(content__$54||content__$54===0){isBEM__$15=__$ctx.block||__$ctx.elem;var __$r__$57;var __$l11__$58=__$ctx._mode;__$ctx._mode="";var __$l12__$59=__$ctx._notNewList;__$ctx._notNewList=false;var __$l13__$60=__$ctx.position;__$ctx.position=isBEM__$15?1:__$ctx.position;var __$l14__$61=__$ctx._listLength;__$ctx._listLength=isBEM__$15?1:__$ctx._listLength;var __$l15__$62=__$ctx.ctx;__$ctx.ctx=content__$54;__$r__$57=applyc(__$ctx,__$ref);__$ctx._mode=__$l11__$58;__$ctx._notNewList=__$l12__$59;__$ctx.position=__$l13__$60;__$ctx._listLength=__$l14__$61;__$ctx.ctx=__$l15__$62}if(tag__$16)__$ctx._str+="</"+tag__$16+">"}result__$17=__$ctx._str;__$r__$18=undefined;__$ctx._str=__$l0__$19;__$ctx._buf.push(result__$17);return}function __$b16(__$ctx,__$ref){__$ctx.__$a=0;var __$r__$63;var __$l0__$64=__$ctx._mode;__$ctx._mode="";var __$l1__$65=__$ctx.ctx;__$ctx.ctx=__$ctx.ctx._value;var __$r__$66;__$ctx.__$a=1;__$r__$66=applyc(__$ctx,__$ref);__$r__$63=__$r__$66;__$ctx._mode=__$l0__$64;__$ctx.ctx=__$l1__$65;return}function __$b17(__$ctx,__$ref){__$ctx.__$a=0;__$ctx._listLength--;var ctx__$67=__$ctx.ctx;if(ctx__$67&&ctx__$67!==true||ctx__$67===0){__$ctx._buf.push(ctx__$67+"")}return}function __$b18(__$ctx,__$ref){__$ctx.__$a=0;__$ctx._listLength--;return}function __$b19(__$ctx,__$ref){__$ctx.__$a=0;var v__$68=__$ctx.ctx,l__$69=v__$68.length,i__$70=0,prevPos__$71=__$ctx.position,prevNotNewList__$72=__$ctx._notNewList;if(prevNotNewList__$72){__$ctx._listLength+=l__$69-1}else{__$ctx.position=0;__$ctx._listLength=l__$69}__$ctx._notNewList=true;while(i__$70<l__$69)!function(){var __$r__$73;var __$l0__$74=__$ctx.ctx;__$ctx.ctx=v__$68[i__$70++];__$r__$73=applyc(__$ctx,__$ref);__$ctx.ctx=__$l0__$74;return __$r__$73}();prevNotNewList__$72||(__$ctx.position=prevPos__$71);return}function __$b20(__$ctx,__$ref){__$ctx.__$a=0;var vBlock__$75=__$ctx.ctx.block,vElem__$76=__$ctx.ctx.elem,block__$77=__$ctx._currBlock||__$ctx.block;__$ctx.ctx||(__$ctx.ctx={});var __$r__$78;var __$l0__$79=__$ctx._mode;__$ctx._mode="default";var __$l1__$80=__$ctx.block;__$ctx.block=vBlock__$75||(vElem__$76?block__$77:undefined);var __$l2__$81=__$ctx._currBlock;__$ctx._currBlock=vBlock__$75||vElem__$76?undefined:block__$77;var __$l3__$82=__$ctx.elem;__$ctx.elem=__$ctx.ctx.elem;var __$l4__$83=__$ctx.mods;__$ctx.mods=vBlock__$75?__$ctx.ctx.mods||(__$ctx.ctx.mods={}):__$ctx.mods;var __$l5__$84=__$ctx.elemMods;__$ctx.elemMods=__$ctx.ctx.elemMods||{};__$ctx.block||__$ctx.elem?__$ctx.position=(__$ctx.position||0)+1:__$ctx._listLength--;applyc(__$ctx,__$ref);__$r__$78=undefined;__$ctx._mode=__$l0__$79;__$ctx.block=__$l1__$80;__$ctx._currBlock=__$l2__$81;__$ctx.elem=__$l3__$82;__$ctx.mods=__$l4__$83;__$ctx.elemMods=__$l5__$84;return}function __$g0(__$ctx,__$ref){var __$t=__$ctx._mode;if(__$t==="content"){var __$t=__$ctx.block;if(__$t==="github"){if(!__$ctx.elem){__$ctx.__$a=0;return[{elem:"header",content:[{elem:"title",content:"Me on GitHub",mix:{block:"box",elem:"title"}}]},{elem:"body"}]}if(__$ctx.elem==="repo"){__$ctx.__$a=0;return{block:"link",mix:[{block:"github",elem:"link"}],url:__$ctx.ctx.info.url,content:__$ctx.ctx.info.name}}}__$ctx.__$a=0;return __$ctx.ctx.content}else if(__$t==="attrs"){var __$t=__$ctx.block;if(__$t==="link"){if(!__$ctx.elem){__$ctx.__$a=0;var __$r=__$b4(__$ctx,__$ref);if(__$r!==__$ref)return __$r}if(!__$ctx.elem){__$ctx.__$a=0;var __$r=__$b5(__$ctx,__$ref);if(__$r!==__$ref)return __$r}}__$ctx.__$a=0;return undefined}else if(__$t==="tag"){var __$t=__$ctx.block;if(__$t==="github"){if(__$ctx.elem==="repo"){__$ctx.__$a=0;return"li"}}else if(__$t==="link"){if(!__$ctx.elem){__$ctx.__$a=0;return"a"}if(!__$ctx.elem){__$ctx.__$a=0;return"a"}}__$ctx.__$a=0;return undefined}else if(__$t==="mix"){__$ctx.__$a=0;return undefined}else if(__$t==="bem"){__$ctx.__$a=0;return undefined}else if(__$t==="js"){__$ctx.__$a=0;return undefined}else if(__$t==="cls"){__$ctx.__$a=0;return undefined}else if(__$t==="default"){__$ctx.__$a=0;var __$r=__$b15(__$ctx,__$ref);if(__$r!==__$ref)return __$r}else if(__$t===""){if(__$ctx.ctx&&__$ctx.ctx._vow&&__$ctx.__$a!==1){__$ctx.__$a=0;var __$r=__$b16(__$ctx,__$ref);if(__$r!==__$ref)return __$r}if(__$ctx._.isSimple(__$ctx.ctx)){__$ctx.__$a=0;var __$r=__$b17(__$ctx,__$ref);if(__$r!==__$ref)return __$r}if(!__$ctx.ctx){__$ctx.__$a=0;var __$r=__$b18(__$ctx,__$ref);if(__$r!==__$ref)return __$r}if(__$ctx._.isArray(__$ctx.ctx)){__$ctx.__$a=0;var __$r=__$b19(__$ctx,__$ref);if(__$r!==__$ref)return __$r}__$ctx.__$a=0;var __$r=__$b20(__$ctx,__$ref);if(__$r!==__$ref)return __$r}__$ctx.__$a=0;return __$ref};
     return exports;
  })({});
